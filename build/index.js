        ...
        try {
          ...
          if (sanitizedText) {
            ...
            if (buffer.includes('\n')) {
              ...
              const htmlParagraphs = validParagraphs.map(paragraph => (0,marked__WEBPACK_IMPORTED_MODULE_2__.marked)(paragraph));
              const blocks = htmlParagraphs.map(html => {
                ...
                if (isList) {
                  ...
                  return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('core/table', {
                    values: html
                  });
                } else {
              ...
              if (content && content !== htmlParagraphs[0]) {
                const updatedBlock = (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.createBlock)('andika-block/andika', {
                  content: content + htmlParagraphs[0]
                });
